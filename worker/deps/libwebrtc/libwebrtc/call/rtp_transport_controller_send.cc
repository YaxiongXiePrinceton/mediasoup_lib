...
void RtpTransportControllerSend::OnNetworkAvailability(bool network_available) {
  ...
  //MS_DUMP("Yaxiong: OnNetworkAvailability PostUpdates\n");
...
void RtpTransportControllerSend::OnSentPacket(
  ...
  if (packet_msg){
    //MS_DUMP("Yaxiong: OnSentPacket PostUpdates\n");
...
void RtpTransportControllerSend::OnReceivedEstimatedBitrate(uint32_t bitrate) {
  ...
  //MS_DUMP("Yaxiong: OnReceivedEstimatedBitrate PostUpdates\n");
...
void RtpTransportControllerSend::OnReceivedRtcpReceiverReport(
  ...
  if (!report.round_trip_time.IsZero()){
    //MS_DUMP("Yaxiong: OnReceivedRtcpReceiverReport PostUpdates\n");
...
void RtpTransportControllerSend::OnTransportFeedback(
  ...
  if (feedback_msg){
    //MS_DUMP("Yaxiong: OnTransportFeedback PostUpdates\n");
...
void RtpTransportControllerSend::SetDownlinkCapacity(){
	  
	MS_DEBUG_DEV("<<<<<");
	// RTC_DCHECK(controller_);
	MS_ASSERT(controller_, "controller not set");
	MS_DUMP("Yaxiong: GCC capacity_:%d", downlink_capacity_);
}

//void RtpTransportControllerSend::SetDownlinkCapacity(
//		uint32_t capacity){
//  MS_DUMP("Yaxiong: GCC capacity_:%d", downlink_capacity_);
//  //controller_->SetDownlinkCapacity(capacity);
//}
...
void RtpTransportControllerSend::UpdateControllerWithTimeInterval() {
  ...
  //MS_DUMP("Yaxiong: UpdateControllerWithTimeInterval PostUpdates\n");

  NetworkControlUpdate update;
  update = controller_->OnProcessInterval(msg);

  //if (update.pacer_config) {
  //  MS_DUMP("Yaxiong: data rate:%d pad rate:%d\n", update.pacer_config->data_rate().bps(),
  //                        update.pacer_config->pad_rate().bps());
  //}
  //if (update.target_rate) {
  //  MS_DUMP("Yaxiong: target rate:%d \n", update.target_rate->target_rate.bps());
  //}
...
void RtpTransportControllerSend::UpdateStreamsConfig() {
  ...
  if (controller_){
    //MS_DUMP("Yaxiong: UpdateStreamsConfig PostUpdates\n");
...
void RtpTransportControllerSend::OnReceivedRtcpReceiverReportBlocks(
  ...
  MS_DUMP("Yaxiong: OnReceivedRtcpReceiverReportBlocks PostUpdates\n");
