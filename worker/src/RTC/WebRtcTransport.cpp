...
//            MS_DUMP("IsConnected:IceServer connnected or completed! \n");
//        }else{
//            MS_DUMP("IsConnected:IceServer NOT connnected or completed! \n");
//        }
//        if(this->dtlsTransport->GetState() == RTC::DtlsTransport::DtlsState::CONNECTED){
//            MS_DUMP("IsConnected:Dtls connected! \n");
//        }else{
//            MS_DUMP("IsConnected:Dtls NOT connected! \n");
//        }
		// clang-format off
		return (
			(
